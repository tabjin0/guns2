...
DROP DATABASE IF EXISTS v32_guns_flowable;
CREATE DATABASE IF NOT EXISTS v32_guns_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS v32_guns;
CREATE DATABASE IF NOT EXISTS v32_guns DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
